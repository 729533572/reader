...
public class MFSClipView extends View{
    ...
    public MFSClipView(Context context) {
        this(context, null);
    }

    public MFSClipView(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public MFSClipView(Context context, AttributeSet attrs, int defStyle) {
