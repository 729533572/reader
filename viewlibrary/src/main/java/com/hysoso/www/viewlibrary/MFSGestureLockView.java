...
public class MFSGestureLockView extends View
{
	...
	public MFSGestureLockView(Context context , int colorNoFingerInner , int colorNoFingerOutter , int colorFingerOn , int colorFingerUp )
	{
		super(context);
