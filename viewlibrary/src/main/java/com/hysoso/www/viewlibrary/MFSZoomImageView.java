...
public class MFSZoomImageView extends ImageView implements ViewTreeObserver.OnGlobalLayoutListener, View.OnTouchListener, ScaleGestureDetector.OnScaleGestureListener {
    ...
    public MFSZoomImageView(Context context) {
        this(context, null);
    }

    public MFSZoomImageView(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public MFSZoomImageView(Context context, AttributeSet attrs, int defStyleAttr) {
