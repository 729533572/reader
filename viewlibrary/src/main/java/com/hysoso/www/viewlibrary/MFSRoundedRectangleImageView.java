...
/**
 * Created by luhe on 2017/5/11
 * email 1019561500@qq.com
 */

public class MFSRoundedRectangleImageView extends ImageView{
    public MFSRoundedRectangleImageView(Context context) {
        super(context);
        init(context, null);
    }

    public MFSRoundedRectangleImageView(Context context,  AttributeSet attrs) {
        super(context, attrs);
        init(context, attrs);
    }

    public MFSRoundedRectangleImageView(Context context,AttributeSet attrs, int defStyleAttr) {
    ...
    private void init(Context context, AttributeSet attrs) {
        ...
        // 获取控件的属性值
        if (attrs != null) {
            TypedArray array = context.obtainStyledAttributes(attrs, R.styleable.MFSRoundedRectangleImageView);
            borderColor = array.getColor(R.styleable.MFSRoundedRectangleImageView_ml_border_color, borderColor);
            borderWidth = array.getDimensionPixelOffset(R.styleable.MFSRoundedRectangleImageView_ml_border_width, borderWidth);
            pressAlpha = array.getInteger(R.styleable.MFSRoundedRectangleImageView_ml_press_alpha, pressAlpha);
            pressColor = array.getColor(R.styleable.MFSRoundedRectangleImageView_ml_press_color, pressColor);
            radius = array.getDimensionPixelOffset(R.styleable.MFSRoundedRectangleImageView_ml_radius, radius);
            shapeType = array.getInteger(R.styleable.MFSRoundedRectangleImageView_ml_shape_type, shapeType);
            array.recycle();
        }
