...
/**
 * Created by luhe on 17/3/7.
 */

public class MFSClipViewLayout extends RelativeLayout{
    //裁剪原图
    private ImageView imageView;
    //裁剪框
    private MFSClipView clipView;
    ...
    public MFSClipViewLayout(Context context) {
        this(context, null);
    }

    public MFSClipViewLayout(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public MFSClipViewLayout(Context context, AttributeSet attrs, int defStyleAttr) {
    ...
    public void init(Context context, AttributeSet attrs) {
        TypedArray array = context.obtainStyledAttributes(attrs, R.styleable.MFSClipViewLayout);

        //获取剪切框距离左右的边距, 默认为50dp
        mHorizontalPadding = array.getDimensionPixelSize(R.styleable.MFSClipViewLayout_mHorizontalPadding,
                (int) TypedValue.applyDimension(TypedValue.COMPLEX_UNIT_DIP, 50, getResources().getDisplayMetrics()));
        //获取裁剪框边框宽度，默认1dp
        int clipBorderWidth = array.getDimensionPixelSize(R.styleable.MFSClipViewLayout_clipBorderWidth,
                (int) TypedValue.applyDimension(TypedValue.COMPLEX_UNIT_DIP, 1, getResources().getDisplayMetrics()));
        //裁剪框类型(圆或者矩形)
        int clipType = array.getInt(R.styleable.MFSClipViewLayout_clipType, 1);

        //回收
        array.recycle();
        clipView = new MFSClipView(context);
        //设置裁剪框类型
        clipView.setClipType(clipType == 1 ? MFSClipView.ClipType.CIRCLE : MFSClipView.ClipType.RECTANGLE);
        //设置剪切框边框
