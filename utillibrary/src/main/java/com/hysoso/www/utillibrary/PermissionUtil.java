...
public class PermissionUtil{
    ...
    public static final int CODE_GET_ACCOUNTS = 8;
    ...
    private static final String[] requestPermissionsRemind = {
            "手机状态权限",
            "发送短信权限",
            "拨打电话权限",
            "拍照权限",
     ...
     */
    public static void requestPermission(final Context activity, final int requestCode, PermissionGrant permissionGrant) {
        if (activity == null) {
            return;
        }
...
//        }
        ...
        try {
            ...
            ToastUtil.showShort(activity, requestPermissionsRemind[requestCode]+"被拒,请前往手机系统设置打开该权限");
        ...
        if (checkSelfPermission != PackageManager.PERMISSION_GRANTED) {
            ...
            LogUtil.e(TAG,"opened:" + requestPermissions[requestCode]);
    ...
    private static void shouldShowRationale(final Context activity, final int requestCode, final String requestPermission) {
    ...
    private static void shouldShowRationale(final Context activity, final int requestCode, final String requestPermission, final PermissionGrant permissionGrant) {
        String[] permissionsHint = activity.getResources().getStringArray(R.array.permissions);
