 ...
 * 分类
 */
public class CategoryInnerAdapter extends RecyclerView.Adapter<CategoryInnerAdapter.ViewHolder> {
    private Context mContext;
    private List<CategoryInner> posts;
    private int post_width;

    public CategoryInnerAdapter(Context context, List<CategoryInner> posts) {
        this.posts = posts;
        mContext = context;
    ...
    public void onBindViewHolder(ViewHolder holder, final int position) {
        final CategoryInner post = getItem(position);
        if (post != null) {
            holder.setData(post);
            holder.itemView.setOnClickListener(new View.OnClickListener() {
                @Override
                public void onClick(View view) {
                    IntentUtils.startBookListActivity(mContext, Constant.FRAGMENT_CATEGORY_DETAIL, post.getName(), post.getId(),post.getSex());
                }
            });
        }
    ...
    private CategoryInner getItem(int position) {
    ...
    public class ViewHolder extends RecyclerView.ViewHolder {
        ...
        void setData(@NonNull final CategoryInner post) {
            GlideUtils.load(mContext, post.getIcon(), cover);
