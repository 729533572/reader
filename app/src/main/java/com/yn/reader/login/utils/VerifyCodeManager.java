...
public class VerifyCodeManager {
    ...
    private int type;//注册还是找回密码
    public VerifyCodeManager(Activity context, EditText editText, Button btn, RegisterPresenter registerPresenter,int type) {
    ...
    public void getVerifyCode(int type) {
        ...
        registerPresenter.getSmsCode(mContext,phone, this.type);
...
//        getVerifiCodeButton.setBackgroundResource(R.drawable.btn_login);
    }
