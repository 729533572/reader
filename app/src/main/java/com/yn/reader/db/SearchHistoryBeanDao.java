...
public class SearchHistoryBeanDao extends AbstractDao<SearchHistoryBean, Long> {
    ...
    */
    public static class Properties {
        ...
        public final static Property Link_type = new Property(2, int.class, "link_type", false, "LINK_TYPE");
        public final static Property Link_content = new Property(3, String.class, "link_content", false, "LINK_CONTENT");
    };
    ...
    public static void createTable(Database db, boolean ifNotExists) {
        ...
        db.execSQL("CREATE TABLE " + constraint + "\"SEARCH_HISTORY_BEAN\" (" + //
                ...
                "\"LINK_TYPE\" INTEGER NOT NULL ," + // 2: link_type
                "\"LINK_CONTENT\" TEXT);"); // 3: link_content
    }
    ...
    protected final void bindValues(DatabaseStatement stmt, SearchHistoryBean entity) {
        ...
        stmt.bindLong(3, entity.getLink_type());
 
        String link_content = entity.getLink_content();
        if (link_content != null) {
            stmt.bindString(4, link_content);
        }
    }
    ...
    public SearchHistoryBean readEntity(Cursor cursor, int offset) {
        SearchHistoryBean entity = new SearchHistoryBean( //
            ...
            cursor.getInt(offset + 2), // link_type
            cursor.isNull(offset + 3) ? null : cursor.getString(offset + 3) // link_content
        );
        return entity;
    }
    ...
    public void readEntity(Cursor cursor, SearchHistoryBean entity, int offset) {
        ...
        entity.setLink_type(cursor.getInt(offset + 2));
        entity.setLink_content(cursor.isNull(offset + 3) ? null : cursor.getString(offset + 3));
     }
