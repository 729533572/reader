...
public class BookContentBeanDao extends AbstractDao<BookContentBean, String> {
    ...
    */
    public static class Properties {
        ...
        public final static Property Chapterdetails = new Property(2, String.class, "chapterdetails", false, "CHAPTERDETAILS");
        public final static Property Chaptertitle = new Property(3, String.class, "chaptertitle", false, "CHAPTERTITLE");
    ...
    public static void createTable(Database db, boolean ifNotExists) {
        ...
        db.execSQL("CREATE TABLE " + constraint + "\"BOOK_CONTENT_BEAN\" (" + //
                ...
                "\"CHAPTERDETAILS\" TEXT," + // 2: chapterdetails
                "\"CHAPTERTITLE\" TEXT," + // 3: chaptertitle
                "\"TAG\" TEXT);"); // 4: tag
    }
    ...
    protected final void bindValues(DatabaseStatement stmt, BookContentBean entity) {
        ...
        String chapterdetails = entity.getChapterdetails();
        if (chapterdetails != null) {
            stmt.bindString(3, chapterdetails);
        }
    ...
    public BookContentBean readEntity(Cursor cursor, int offset) {
        BookContentBean entity = new BookContentBean( //
            ...
            cursor.isNull(offset + 2) ? null : cursor.getString(offset + 2), // chapterdetails
    ...
    public void readEntity(Cursor cursor, BookContentBean entity, int offset) {
        ...
        entity.setChapterdetails(cursor.isNull(offset + 2) ? null : cursor.getString(offset + 2));
