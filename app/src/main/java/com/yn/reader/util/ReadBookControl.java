...
//    private int textBackground;
    ...
    private ReadBookControl() {
        if (null == textKind) {
            ...
            temp1.put("textSize", 10);
            temp1.put("textExtra", DensityUtil.dp2px(MiniApp.getInstance(), 6.5f));
            textKind.add(temp1);

            Map<String, Integer> temp2 = new HashMap<>();
            temp2.put("textSize", 15);
            temp2.put("textExtra", DensityUtil.dp2px(MiniApp.getInstance(), 8));
            textKind.add(temp2);

            Map<String, Integer> temp3 = new HashMap<>();
            temp3.put("textSize", 20);
            temp3.put("textExtra", DensityUtil.dp2px(MiniApp.getInstance(), 9));
            textKind.add(temp3);

            Map<String, Integer> temp4 = new HashMap<>();
            temp4.put("textSize", 25);
            temp4.put("textExtra", DensityUtil.dp2px(MiniApp.getInstance(), 11));
            textKind.add(temp4);

            Map<String, Integer> temp5 = new HashMap<>();
            temp5.put("textSize", 22);
            temp5.put("textExtra", DensityUtil.dp2px(MiniApp.getInstance(), 13));
            textKind.add(temp5);
        }
        ...
        preference = MiniApp.getInstance().getSharedPreferences("CONFIG", 0);
...
//        this.textBackground = R.color.book_bg_color;
//        if(AppPreference.getInstance().isNightModel()){
//            this.textBackground = R.color.book_night_bg_color;
//        }
    ...
    public int getTextBackground() {
        if (AppPreference.getInstance().isNightModel()) {
            return R.color.book_night_bg_color;
        }
        return R.color.book_bg_color;
    }
